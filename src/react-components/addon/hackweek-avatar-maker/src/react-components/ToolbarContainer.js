...
function dispatchSaveAvatar() {
  dispatch(constants.saveAvatar);
}
  ...
  return (
    <Toolbar>
      <div className="toolbarContent">
        ...
        <button onClick={dispatchSaveAvatar}>
          Save avatar
        </button>
      </div>
      <div className="toolbarNotice">
        <span>The 3D models used in this app are ©2020-2022 by individual <a href="https://www.mozilla.org" target="_blank" noreferrer="true">mozilla.org</a> contributors.
          Content available under a <a href="https://www.mozilla.org/en-US/foundation/licensing/website-content/" target="_blank" noreferrer="true">Creative Commons license</a>.</span>
      </div>
    </Toolbar>
  );
}
